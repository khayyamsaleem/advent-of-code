...
int Day1::get_two_digit_number_2(std::string s) {
...
int Day1::get_two_digit_number(std::string s) {
    char first = '-';
    char second = '-';
...
int Day1::solve_part1(std::string input) {
    int sum = 0;
...
int Day1::solve_part2(std::string input) {
    int sum = 0;
    auto ss = std::stringstream{input};
    for (std::string line; std::getline(ss, line, '\n');) {
