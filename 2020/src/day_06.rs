...
pub async fn solve() -> Result<(), Error> {
    ...
    println!("Day 06 Part 1: {:?}", count_sum_for_questions_per_group(&groups));
    println!("Day 06 Part 2: {:?}", count_sum_for_all_answered_per_group(&groups));
    Ok(())
}
...
"
    ...
    fn test_count_sum_for_groups() {
        assert_eq!(count_sum_for_questions_per_group(
            &vec!(
                vec!("abc"),
                vec!("a", "b", "c"),
                vec!("ab", "ac"),
    ...
    fn test_count_all_answered_per_group() {
        assert_eq!(count_sum_for_all_answered_per_group(
            &vec!(
                vec!("abc"),
                vec!("a", "b", "c"),
                vec!("ab", "ac"),
